...
function(AddCoverage target)
  ...
  add_custom_target(coverage-${target}
    COMMAND ${LCOV_PATH} --gcov-tool gcov-13 -d . --zerocounters
    COMMAND $<TARGET_FILE:${target}>
    COMMAND ${LCOV_PATH} --gcov-tool gcov-13 -d . --capture -o coverage.info
    COMMAND ${LCOV_PATH} --gcov-tool gcov-13 -r coverage.info '/usr/include/*' -o filtered.info
